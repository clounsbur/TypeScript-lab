...
function findMountainHeights(mountains: Mountain[]): string {
...
let nameOfTallestMountain = findMountainHeights(mountains);
...
let averageOfProducts = calcAverageProductPrice(products);
